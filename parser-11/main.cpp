...
public:
    ...
    void createPPM(char *filename, char *log/*, int iteration*/) {
        ofstream myfile;
...
//        int iterLen = strlen(numStr.c_str());

        char *filenameWithIter = new char[filenameLen/*+iterLen*/];
        char *logWithIter= new char[logLen/*+iterLen*/];
        strcpy(filenameWithIter, filename);
//        strcat(filenameWithIter, numStr.c_str());
        strcpy(logWithIter,log);
//        strcat(logWithIter, numStr.c_str());
//        cout<<filenameWithIter<<endl;
//        cout<<logWithIter<<endl;

        myfile.open(strcat(filenameWithIter, ".ppm"));
        myfile << "P3" << endl;
        myfile << Width << endl;
        myfile << Height << endl;
        myfile << 255 << endl;
...
//            i++;
        ...
        myfile.open(strcat(logWithIter,".txt"));
        myfile << Caption <<endl;
        myfile << Width <<endl;
        myfile << Height <<endl;
...
//                        std::cout << "Animations" << std::endl;
                        ...
                        read_animations(animations, decimal_length, filename, log/*, iteration*/);
...
//        std::cout << Creator <<std::endl;
    ...
    void read_animations(char* chars, size_t length , char *filename, char *log/*, int iteration*/) {
        char duration[8];
...
//        cout << chars << endl;
        ...
        parseCiff(chars, filename, log/*, iteration*/);

    }

    // Get CIFF data from byte array
    void parseCiff(char* chars, char *filename, char *log/*, int iteration*/){
        string magic;
        char h_size[8];
        char content_size[8];
        char width[8];
...
//        cout<<"Caption: "<<caption<<endl;
        ...
        l_ciff.createPPM(filename, log/*, iteration*/);
...
//    filenameStream << "2.caff";
//    std::string filename = filenameStream.str();
//
//    std::ostringstream ppmStream;
//    ppmStream << "caff_prev";
//    std::string ppmName = ppmStream.str();
//
//    std::ostringstream logStream;
//    logStream << "caff_log";
//    std::string logName = logStream.str();
//
//    caff.read_from_file(const_cast<char *>(filename.c_str()), const_cast<char *>(ppmName.c_str()),
